...
class ThrowerAnt(Ant):
    ...
    def nearest_bee(self, beehive):
        ...
        if(not current):
            return None
        while True:
            if i>=self.min_range and i<=self.max_range and current.bees:
                break
            if not current.entrance or i >= self.max_range:
                return None
...
class FireAnt(Ant):
    ...
    def reduce_armor(self, amount):
        ...
        for i in bees_in_place:
            Insect.reduce_armor(i,amount+bonus)
...
# END Problem 13
    ...
    def __init__(self, armor=1):
        ...
        self.allow = QueenAnt.allow
        QueenAnt.allow = False
        # END Problem 13
    ...
    def reduce_armor(self, amount):
        ...
        if(self.armor<=0):
            if(self.allow==False):
                Insect.remove_from(self, self.place)
            else:
                bees_win()
        # END Problem 13
